...
public class CharacterJFrame extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        jTextAttacksNumber = new javax.swing.JTextField();
        jTextFieldBaseAttackBonus = new javax.swing.JTextField();
        ...
        jLabel11.setText("Number of Attacks : ");

        jLabel18.setText("Base Attack Bonus : ");

        jTextAttacksNumber.setEditable(false);
        jTextAttacksNumber.setText("0");

        jTextFieldBaseAttackBonus.setEditable(false);
        jTextFieldBaseAttackBonus.setText("0");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jTextAttacksNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 62, Short.MAX_VALUE)
                .addComponent(jLabel18)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTextFieldBaseAttackBonus, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(54, 54, 54))
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel11)
                    .addComponent(jLabel18)
                    .addComponent(jTextAttacksNumber, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTextFieldBaseAttackBonus, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    {//GEN-HEADEREND:event_jMenuItemOpenActionPerformed
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION)
        {
            ...
            try
            {
                ...
                jTextFieldStrengthModifier.setText(Integer.toString(_loadedCharacter.getStrengthModifier()));//modified by khush
    ...
    {//GEN-HEADEREND:event_jButtonSaveActionPerformed
        ...
        jTextFieldStrengthModifier.setText(Integer.toString( _character.getStrengthModifier()));
        jTextFieldDexterityModifier.setText(Integer.toString(_character.getDexterityModifier()));
        jTextFieldConstitutionModifier.setText(Integer.toString(_character.getConstitutionModifier()));
        jTextFieldIntelligenceModifier.setText(Integer.toString(_character.getIntelligenceModifier()));
        jTextFieldWisdomModifier.setText(Integer.toString(_character.getWisdomModifier()));
        jTextFieldCharismaModifier.setText(Integer.toString(_character.getCharismaModifier()));

        jTextFieldHitPoints.setText(Integer.toString(_character.getMaxHitPoints()));
        jTextAttacksNumber.setText(Integer.toString(_character.getAttackPerRound()));
        jTextFieldBaseAttackBonus.setText(Integer.toString(_character.getBaseAttackBonus()));
    ...
    /**
     * This is a public function called character generation.
    ...
    private javax.swing.JTextField jTextAttacksNumber;
    private javax.swing.JTextField jTextFieldBaseAttackBonus;
